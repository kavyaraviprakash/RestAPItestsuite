...
class Tc_navbar(unittest.TestCase):
    @classmethod
    def setUp(self):
    ...
    def test_ebuy(self):
        ...
        # elem.click()
        # time.sleep(3)
        elem = driver.find_element_by_xpath("/html/body/nav/li/ul[1]/li[2]/a")
        elem.click()
        time.sleep(3)
        elem = driver.find_element_by_xpath("/html/body/nav/li/ul[1]/li[3]/a")
        elem.click()
        time.sleep(3)
