...
class TC_currency_selection(unittest.TestCase):
    @classmethod
    def setUp(self):
    ...
    def test_ebuy(self):
        ...
        elem.click()
        time.sleep(3)
        elem = driver.find_element_by_xpath("//select[@name='selectedcountry']/option[text()='India']")
        elem.click()
        time.sleep(3)
        elem = driver.find_element_by_xpath("/html/body/div[3]/div[2]/form/button")
        elem.click()
        time.sleep(3)
