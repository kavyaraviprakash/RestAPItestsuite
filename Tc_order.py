...
class Tc_order(unittest.TestCase):
    @classmethod
    def setUp(self):
    ...
    def test_ebuy(self):
        ...
        elem.click()
        time.sleep(3)
        elem = driver.find_element_by_xpath("/html/body/nav/li/ul[2]/li/div/a[1]")
        elem.click()
        time.sleep(3)
        elem = driver.find_element_by_xpath("/html/body/div[3]/table/tbody/tr[1]/td[4]/a")
        elem.click()
        time.sleep(3)
